...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "💬 Stickman Daily!\n\n#stickman #funny #comedy"
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Daily Stickman Comedy! 😂"
    title = sys.argv[3] if len(sys.argv) > 3 else "Stickman"
